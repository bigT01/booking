...
const Page = () => {
    ...
    return (
        <div>
            <header className={'mx-8 pt-8 flex items-center justify-between'}>
                <button
                    onClick={() => {
                        router.push('/')
                    }}
                    className={'w-[53px] h-[53px] flex items-center justify-center bg-[#F74346] rounded-[13px] '}>
                ...
                <h4 className={'text-center font-bold text-white text-3xl'}>Select Date </h4>
                <div></div>
            </header>
        </div>
    );
